...
COPY --from=builder /builder/src/extensions/endpoints/local-adoption/dist/* /directus/extensions/unadopted-probes/dist/
COPY --from=builder /builder/src/extensions/endpoints/local-adoption/package.json /directus/extensions/unadopted-probes/
