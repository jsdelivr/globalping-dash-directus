		...
		expect(createOne.args[0]).to.deep.equal([
			{
				...
				message: 'Your [probe with IP address **undefined**](/probes/probe-id) has outdated firmware and we couldn\'t update it automatically. Please update it manually using the guide from [GitHub](https://github.com/jsdelivr/globalping-hwprobe#download-the-latest-firmware).',
				item: 'probe-id',
